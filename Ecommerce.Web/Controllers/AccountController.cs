...
namespace Ecommerce.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        public AccountController()
            : this(new UserManager<User>(new UserStore<User>(new EcommerceContext())))
        {
        }
        ...
        private const string DefaultUserEmail = "admin@ecommerce.ng";

        // 
        // GET: /Account/CreateInitialAccount
        [AllowAnonymous]
        public virtual async Task<ActionResult> CreateInitialAccount()
        {
            bool hasLocalAccount = await UserManager.FindByEmailAsync(DefaultUserEmail) != null? true: false;

            if (!hasLocalAccount)
            {
               var user = new User(){UserName = DefaultUserEmail, Email = DefaultUserEmail};
